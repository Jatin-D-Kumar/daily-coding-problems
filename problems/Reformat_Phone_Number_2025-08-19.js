...
console.log(reformatPhoneNumber("123 4-567")); // Output: "123-45-67"
console.log(reformatPhoneNumber("123 4-56"));  // Output: "123-456"
console.log(reformatPhoneNumber("123"));        // Output: "123"
